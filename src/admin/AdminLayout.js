...
const AdminLayout = () => {
  ...
  const menuItems = [
    ...
    { path: '/admin/testimonials', label: t('admin.testimonials') || 'Testimonials', icon: <FaQuoteRight /> },
    { path: '/admin/social-feed', label: t('admin.socialFeed') || 'Social Feed', icon: <FaBroadcastTower /> },
    { path: '/admin/press-mentions', label: t('admin.pressMentions') || 'Press Mentions', icon: <FaRegNewspaper /> },
